...
// --- WORKER EKLEME (ÖZEL İSİM DESTEĞİ) ---
document.getElementById("addWorkerBtn").addEventListener("click", () => {
    ...
    div.innerHTML = `
        ...
        <input type="text" class="customWorkerInput" placeholder="Name eintragen (Leiharbeiter/Gast)" style="display:none; margin-top:10px;">
    `;
...
function validateAusschuss(box) {
    ...
    if (ist !== soll && soll >= 0) {
        warnung.innerText = `⚠️ Summe (${ist}) stimmt değil mit Gesamt (${soll}) überein!`;
...
async function speichern() {
    ...
    // Mitarbeiter Listesini Al (Sonstige ise özel ismi al)
    let staff = [];
